...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Load synthetic KCD/EDI registry data into Starter Kit SQLite.")
    parser.add_argument("--generated-dir", default=None, help="Path to data_generator/generated")
    args = parser.parse_args(argv)

    settings = Settings.load()
    generated_dir = Path(args.generated_dir) if args.generated_dir else settings.template_root.parent / "data_generator" / "generated"
